...
grid.arrange(prot_weekday, carb_weekday, fat_weekday, fibe_weekday, ncol=2, nrow =2, left = yleft_weekday)
```
...
yleft_weekend = richtext_grob("Hours of Sleep on Weekdays", rot=90)

grid.arrange(prot_weekend, carb_weekend, fat_weekend, fibe_weekend, ncol=2, nrow =2, left = yleft_weekend)
```
...
grid.arrange(prot_sleepy, carb_sleepy, fat_sleepy, fibe_sleepy, ncol=2, nrow =2, left = yleft_sleepy)
```
...
yleft_trouble = richtext_grob("Ever Told the Doctor You Had Trouble Sleeping", rot=90)

grid.arrange(prot_trouble, carb_trouble, fat_trouble, fibe_trouble, ncol=2, nrow =2, left = yleft_trouble)
```
...
grid.arrange(breakfast_weekday, lunch_weekday, dinner_weekday, ncol=2, nrow =2, left = yleft_meal_weekday)
```
...
grid.arrange(breakfast_weekend, lunch_weekend, dinner_weekend, ncol=2, nrow =2, left = yleft_meal_weekend)
```
...
grid.arrange(breakfast_sleepy, lunch_sleepy, dinner_sleepy, ncol=2, nrow =2, left = yleft_meal_sleepy)
```
...
yleft_meal_trouble = richtext_grob("Ever Told the Doctor You Had Trouble Sleeping", rot=90)

grid.arrange(breakfast_trouble, lunch_trouble, dinner_trouble, ncol=2, nrow =2, left = yleft_meal_trouble)
```
